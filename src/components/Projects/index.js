...
import Burger from "../Assets/projects/the-burger-joint.PNG";
import Vireo from "../Assets/projects/vireo_screenshot.PNG";
import Spyglass from "../Assets/projects/Spyglass.PNG";
import WhatWeather from "../Assets/projects/what-weather.PNG";
import HourlyPlanner from "../Assets/projects/hourly-planner-webpage.PNG";
import Fitness from "../Assets/projects/fitness_tracker.PNG";
import "./style.css";
  ...
  return (
    ...
    <section className="row ">
      ...
      <div className="col-lg-4 portfolioPic">
        ...
        />
        <a href="https://hidden-ravine-71551.herokuapp.com/" target="_blank" rel="noreferrer">
          <button id="burgerJoint">The Burger Joint!</button>
        </a>
        <a href="https://github.com/gabel35/The_Burger_Joint" target="_blank" rel="noreferrer">
      ...
      <div className="col-lg-4 portfolioPic">
        <img 
          className="img-fluid hover appPics" 
          src={Vireo} 
          alt="all in one travel app"/>
        <a href="https://peaceful-peak-47552.herokuapp.com/" target="_blank" rel="noreferrer">
          <button id="vireo">Go to Vireo</button>
        </a>
        <a href="https://github.com/gabel35/Vireo" target="_blank" rel="noreferrer">
      ...
      <div className="col-lg-4 portfolioPic">
        ...
        <a href="https://gabel35.github.io/Spyglass/" target="_blank" rel="noreferrer">
          <button id="spyGlass">Go to Spyglass</button>
        </a>
        <a href="https://github.com/gabel35/Spyglass" target="_blank" rel="noreferrer">
    ...
    <section className="row ">
      ...
      <div className="col-lg-4 portfolioPic">
        <img 
          className="img-fluid hover appPics" 
          src={WhatWeather} 
          alt="weather app displaying weather for Newark,Nj"/>
        <a href="https://gabel35.github.io/What_Weather" target="_blank" rel="noreferrer">
          <button id="whatWeather">Go to What Weather?</button>
        </a>
        <a href="https://github.com/gabel35/What_Weather" target="_blank" rel="noreferrer">
      ...
      <div className="col-lg-4 portfolioPic">
        <img 
          className="img-fluid hover appPics" 
          src={HourlyPlanner} 
          alt="planner app with the hours of the day"/>
        <a href="https://gabel35.github.io/9-to-5_Planner/" target="_blank" rel="noreferrer">
          <button id="hourlyPlanner">Go to 9-to-5 Planner</button>
        </a>
        <a href="https://github.com/gabel35/9-to-5_Planner" target="_blank" rel="noreferrer">
      ...
      <div className="col-lg-4 portfolioPic">
        <img 
          ...
          src={Fitness} 
          alt="note taker app"/>
        <a href="https://protected-earth-20674.herokuapp.com/" target="_blank" rel="noreferrer">
          <button id="noteTaker">Go to Fitness Tracker</button>
        </a>
        <a href="https://github.com/gabel35/fitness_tracker" target="_blank" rel="noreferrer">
